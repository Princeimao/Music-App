  ...
  return (
    <div className="bg-[#2F2F2F] h-[100%] w-full rounded-md px-8 py-8 text-white overflow-auto">
      <div className="h-54 w-full flex items-center rounded p-5">
        <div className="bg-orange-400 w-44 h-44 rounded"></div>
        <div>
      ...
      <div className="mt-4">
        ...
        <PlaylistCard count={1} />
        <PlaylistCard count={2} />
        <PlaylistCard count={3} />
        <PlaylistCard count={4} />
        <PlaylistCard count={5} />
        <PlaylistCard count={6} />
      </div>
    </div>
  );
};
